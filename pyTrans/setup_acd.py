...
copy_tree("icons_acd\\matplot", "C:\\Python27\\Lib\\site-packages\\matplotlib\\mpl-data\\images")
...
copy_tree("icons_acd\\mayavi", "C:\\Python27\\Lib\\site-packages\\tvtk\\pyface\\images\\16x16")
...
build_exe_options = {"packages": ["pyface.ui.wx", "tvtk.vtk_module", "tvtk.pyface.ui.wx","matplotlib.backends.backend_tkagg", "matplotlib.backends.backend_ps", "traitsui.wx.range_editor", "tkFileDialog","tkMessageBox"],
                     ...
                     "include_files": [("C:\\Python27\\Lib\\site-packages\\tvtk\\pyface\\images\\", "tvtk\\pyface\\images"),
                                       ...
                                       ("icons_acd\\matplot", "tvtk\\pyface\\images\\16x16"),
                                       ("utilities", "utilities"),
                                       ("icons_acd", "icons"),
                                       ("msvcr\\", ".\\")
                                       ]
...
executables = [
    Executable('run.py', targetName="DigTrace.exe", base='Win32GUI', icon="icons_acd\\64x64.ico", appendScriptToExe=True)
    #Executable('run.py', targetName="DigTrace.exe", base=None, icon="icons_acd\\64x64.ico", appendScriptToExe=True)
]

setup(name='DigTrace Academic',
