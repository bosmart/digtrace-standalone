 ...
 */
FARPROC WINAPI FootProcessorDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = FootProcessorDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = FootProcessorDelayLoadWin32FailureHook;
#endif
